...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/api/public/sarvam/stt' | '/api/public/sarvam/tts'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/api/public/sarvam/stt' | '/api/public/sarvam/tts'
  id: '__root__' | '/' | '/api/public/sarvam/stt' | '/api/public/sarvam/tts'
